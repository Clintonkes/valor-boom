...
// GitHub Pages project deploys serve from a sub-path (e.g. "/stel"). Next.js
// applies that automatically to <Link> and bundled assets, but not to plain
// public/ paths handed to next/image, so it has to be added here.
